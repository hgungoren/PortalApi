...
namespace Serendip.IK.Extensions.Types.Link
{
    public class LinkExtension : ExtensionItemDefination, IExtensionItem
    {
        public string TypeName => ExtensionTypes.LINK;
