...
{
    public partial class SKJobs : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FaaliyetteMi = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    Sistem_Updatetime = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SKJobs", x => x.Id);
                });
        }
